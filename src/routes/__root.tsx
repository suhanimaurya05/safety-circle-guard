...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SheShield — Women Safety & Emergency SOS" },
      {
        name: "description",
        content:
          "SheShield is a women safety app with hold-to-activate emergency SOS, live location sharing, trusted contacts and nearby help.",
      },
      { property: "og:title", content: "SheShield — Women Safety & Emergency SOS" },
      {
        property: "og:description",
        content:
          "Emergency SOS, live location sharing, trusted contacts, safe routes and incident reporting in one calm, fast interface.",
      },
